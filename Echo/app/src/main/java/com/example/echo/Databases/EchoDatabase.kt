...
class EchoDatabase : SQLiteOpenHelper {
    ...
    override fun onCreate(sqliteDatabase: SQLiteDatabase?) {
        sqliteDatabase?.execSQL(
            "CREATE TABLE " + Staticated.TABLE_NAME + "( " + Staticated.COLUMN_ID + " INTEGER, " + Staticated.COLUMN_SONG_ARTIST +
        ...
        try {
            ...
            if (cSor.moveToFirst()) {
                do {
                    ...
                    _songList.add(Songs(_id.toLong(), _title.toString(), _artist.toString(), _songPath.toString(), 0))
